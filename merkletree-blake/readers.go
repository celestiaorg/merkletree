...
func ReaderRoot(r io.Reader, segmentSize int) (root [32]byte, err error) {
	tree := New()
...
func BuildReaderProof(r io.Reader, segmentSize int, index uint64) (root [32]byte, proofSet [][32]byte, numLeaves uint64, err error) {
	tree := New()
